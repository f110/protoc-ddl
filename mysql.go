...
func (m MySQLGenerator) Generate(writer *bytes.Buffer, tables []*Table) {
...
func (m MySQLGenerator) generateColumnDefinition(table *Table) []string {
	colLine := make([]string, 0)
...
func (MySQLGenerator) generateIndexDefinition(table *Table) []string {
	colLine := make([]string, 0)
...
func (MySQLGenerator) columnType(col Column) string {
	columnType := ""
